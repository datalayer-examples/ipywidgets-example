...
# -*- coding: utf-8 -*-
#
# ipywidgets_example documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipywidgets_example', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipywidgets_exampledoc'
...
latex_documents = [
    (master_doc, 'ipywidgets_example.tex', 'ipywidgets_example Documentation',
     'Eric Charles', 'manual'),
]
...
man_pages = [
    (master_doc,
    'ipywidgets_example',
    'ipywidgets_example Documentation',
     [author], 1)
]
